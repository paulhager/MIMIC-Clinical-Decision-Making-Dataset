...
def write_hadm_to_file(hadm_info, filename, base):
    with open(join(base, filename + ".pkl"), "wb") as f:
        pickle.dump(hadm_info, f)


# Load from pickle
def load_hadm_from_file(filename, base):
    with open(join(base, filename + ".pkl"), "rb") as f:
